        ...
        <div className="w-full bg-gray-50">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 
                    ...
                    >
                        ...
                        <p className="text-lg sm:text-xl text-gray-200">
                            We offer 100% free car removal across Sydney, no matter the make or condition. Quick, safe, and hassle-free.
                        </p>
                        <motion.a
                            href="#contact"
            ...
            <section className="py-24 bg-linear-to-b from-gray-50 to-gray-100 relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-800">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {[
                            { icon: Truck, title: "Fast & Reliable", desc: "Our team comes to you quickly and removes your car safely." },
                            { icon: Truck, title: "Free Removal", desc: "No hidden costs — we remove cars for free anywhere in Sydney." },
                            { icon: Truck, title: "Eco-Friendly", desc: "We recycle and dismantle cars responsibly, protecting the environment." },
                        ].map((feature, idx) => (
                            <motion.div
                                key={idx}
            ...
            <section className="py-24 bg-linear-to-b from-gray-50 to-gray-100 relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-20 relative">
                        {[
                            { step: 1, title: "Request a Pickup", desc: "Call us or fill out the online form to schedule your free car removal." },
                            { step: 2, title: "We Arrive Quickly", desc: "Our team arrives at your location with a tow truck and prepares your vehicle for removal." },
                            { step: 3, title: "Car Removed & Recycled", desc: "Your vehicle is removed safely and recycled or dismantled responsibly." },
                        ].map((item, idx) => (
                            <motion.div
                                key={idx}
                                initial={{ opacity: 0, y: 40 }}
                            ...
                            >
                                ...
                                {/* Step connecting line (except last) */}
                                {idx < 2 && (
            ...
            <section id="contact" className="py-20 bg-[#0c55a6] text-white">
                <div className="max-w-3xl mx-auto text-center px-4">
                    ...
                    >
                        Call us now or fill out the online form and get your car removed quickly and hassle-free.
                    </motion.p>
                    <motion.a
                        href="tel:+0402887766"
                        whileHover={{ scale: 1.05 }}
