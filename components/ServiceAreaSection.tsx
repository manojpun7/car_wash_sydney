...
const CityCard: React.FC<CityCardProps> = ({ cityName, index }) => {
  return (
    <motion.div
      ...
      className="bg-white rounded-lg p-4 flex items-center justify-center text-center
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left mb-12 md:mb-16">
          <div className="flex items-center mb-3">
            <h3 className="text-sm font-bold uppercase tracking-widest relative mr-4" style={{ color: PRIMARY_BLUE }}>
              SERVICE AREAS
            </h3>
          ...
          <h2 className="text-4xl sm:text-5xl font-extrabold leading-tight tracking-tight mt-4" style={{ color: HEADING_COLOR }}>
            ...
            <span className="inline-block px-1 rounded-md relative pb-1" style={{ color: PRIMARY_BLUE }}>
              SYDNEY
              <span className="absolute left-0 bottom-0 w-full h-2" style={{ backgroundColor: ACCENT_YELLOW }}></span>
            </span>
          </h2>
        </div>
